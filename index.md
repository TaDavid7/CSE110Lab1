...
This is my setup from 2020 at home
![Screenshot of my old setup back in 2020 at home](/CSE110Lab1/images/IMG_1060.jpg)

### About Me
I am a second year CS major at **University of California, San Diego**. My hobbies *include* playing the piano, drawing, watching videos and playing games. I have played the piano for <ins> 10 years</ins> and play mostly classical music. I do want to move into playing other music from other genres, like something from *Star Wars* as I had just started watching.

### Favorite Programming Languages here
Check out my favorite language in [README.md](/CSE110Lab1/README.md) <br>
This is how I view other programming languages
1. ""
2. Python
3. JavaScript
4. C++
...
Here is how you can add your favorite quotes to a txt in a repo, make sure you edit the txt to include what you like
```
git add starwarsquotes.txt
